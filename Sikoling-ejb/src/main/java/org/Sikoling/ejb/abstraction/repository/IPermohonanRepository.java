...
public interface IPermohonanRepository extends IRepository<Permohonan> {	
	...
	List<Permohonan> getByProduk(ProdukDLH produk);
	List<Permohonan> getByKategoriProduk(KategoriProduk kategoriProduk);	
	List<Permohonan> getByUserAndProduk(User user, ProdukDLH produk);
	...
	List<Permohonan> getByUserAndProdukAndPemrakarsa(User user, ProdukDLH produk, Pemrakarsa pemrakarsa);
