...
public class DataConverter {	
	...
	public KategoriPelakuUsahaData convertKategoriPelakuUsahaToKategoriPelakuUsahaData(KategoriPelakuUsaha t) {
		...
		if(t != null) {
			...
			kategoriPelakuUsahaData.setId(id != null ? id : getGenerateIdKategoriPelakuUsaha(t.getSkalaUsaha().getId()));
...
//			autorisasiData.setStatusInternal(autority.isStatusInternal());
	...
	private String getGenerateIdKategoriPelakuUsaha(String idSkalaUsaha) {
		String hasil;
