...
@NamedQuery(name="KecamatanData.findAllByIdKabupatenAndQueryNama", query="SELECT k FROM KecamatanData k WHERE k.nama LIKE :nama AND k.idKabupaten = :idKabupaten")})
