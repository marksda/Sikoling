...
import org.Sikoling.ejb.main.repository.pelakuusaha.DetailPelakuUsahaJPA;
...
public class RepositoryProvider {
	...
	@Produces
	public DetailPelakuUsahaJPA getDetailPelakuUsahaJPA(EntityManager entityManager) {
		return new DetailPelakuUsahaJPA(entityManager);
	}
