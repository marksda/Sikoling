...
@NamedQueries({
	@NamedQuery(name="HakAksesData.findAll", query="SELECT m FROM HakAksesData m"),
	@NamedQuery(name="HakAksesData.findByNama", query="SELECT m FROM HakAksesData m WHERE m.nama LIKE :nama")
})
